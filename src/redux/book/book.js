...
export const getBooks = createAsyncThunk(GET_BOOK, async (post, { dispatch }) => {
  const response = await fetch('https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/l9DazaxzfYVs7RfFk4c2/books');
...
const addBook = createAsyncThunk(ADD__BOOK, async (book, { dispatch }) => {
  await fetch('https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/l9DazaxzfYVs7RfFk4c2/books', {
    method: 'POST',
...
const removeBook = createAsyncThunk(REMOVE__BOOK, async (id, { dispatch }) => {
  await fetch(`https://us-central1-bookstore-api-e63c8.cloudfunctions.net/bookstoreApi/apps/l9DazaxzfYVs7RfFk4c2/books/${id}`, {
    method: 'DELETE',
  });
  dispatch({
    type: REMOVE__BOOK,
